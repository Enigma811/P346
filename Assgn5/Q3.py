...
fout = open(r"C:\Main\Study\Sem 5\P346 Computational Phy Lab\Code\Assgn5\Q3 out.txt", "w+")
fout.writelines("Solution by Midpoint Integration (Precision - 10^(-4))\n\n"+"Given, Length of rod = 2 m\n"+"Linear mass density = x^2\n")
fout.close()

fout = open(r"C:\Main\Study\Sem 5\P346 Computational Phy Lab\Code\Assgn5\Q3 out.txt", "a")
