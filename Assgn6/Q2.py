...
def bdODE(f1,f2,x0,y10,y11,y20,tol,h=0.1,n=50):
# 'f1' - (dy1/dx) 
...
pr,iter,ini = bdODE(fn,gn,0,40,200,"a",0.0001,0.1,100)
...
#file print module
fout = open(r"C:\Main\Study\Sem 5\P346 Computational Phy Lab\Code\Assgn6\Q2 out.txt", "w+")
fout.writelines("1-D Heat conduction (d^2T/dx^2 + alpha*(T_a - T) = 0): Shooting Method (RK4)\n\n")
fout.close()
fout = open(r"C:\Main\Study\Sem 5\P346 Computational Phy Lab\Code\Assgn6\Q2 out.txt", "a")
...
fout.writelines("Number of iterations to achieve given precision: "+str(iter)+"\n\n")
fout.writelines("Estimated position at which T(x) = 100: "+str(pos)+" m\n")
